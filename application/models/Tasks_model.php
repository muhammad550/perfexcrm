...
class Tasks_model extends App_Model
{
    ...
    public function get_related_customer($id)
    {
        ...
        if($task){
            $this->db->select('*');
            $this->db->where('userid', $task->rel_id);
